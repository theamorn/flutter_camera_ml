...
/**
 * This class handles the camera permissions for the Face Liveness Detection.
 */
class FaceLivenessDetectionPermissions {
    companion object {
    ...
    fun requestPermission(
        ...
        if (listener == null) {
            ...
            listener = FaceLivenessDetectionPermissionsListener(object : ResultCallback {
        ...
        ActivityCompat.requestPermissions(
            activity, arrayOf(permission.CAMERA), REQUEST_CODE
        )
    }
}
